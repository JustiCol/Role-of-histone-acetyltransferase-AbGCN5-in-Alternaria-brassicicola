...
It includes:
- Raw phenotyping data (seed infection assays)
- Expanded 0/1 datasets used for logistic regression
- R scripts for data transformation, model fitting and plotting
...
Colou J, Bastide F, Hamon B, Simoneau P, Guillemette T
